 ...
 *           <div style={{ ...styles.title, fontFamily: 'Inter UI Black' }}>Sign in to claim<br /> <span style={styles.amountSymbol}><span style={{ fontFamily: 'Inter UI Bold' }}>{this.state.amount}</span> {this.state.tokenSymbol}</span><span style={{ fontFamily: 'Inter UI Bold' }} /></div>
 *         </div>
 *       </div>
 *     )
 *   }
 ...
 *     return (
 *       <div>
 *         <Avatar className='img-responsive' style={{ ...styles.tokenIcon, borderRadius: 50 }} email={this.state.referree.email} src={this.state.referree.picture} size='100' round />
 *         <div style={{ ...styles.amountContainer, width: 300, margin: 'auto' }}>
 *           <div style={{ ...styles.title, fontFamily: 'Inter UI Black' }}>{this.state.referree.given_name} sent you<br /> <span style={styles.amountSymbol}><span style={{ fontFamily: 'Inter UI Bold' }}>{this.state.amount}</span> {this.state.tokenSymbol}</span><span style={{ fontFamily: 'Inter UI Bold' }} /></div>
 *         </div>
 *       </div>
 *     )
 *   }
