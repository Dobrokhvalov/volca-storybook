...
class CompletedReceivedScreen extends Component {
  ...
  _renderInviteText (transfer) {
    ...
    return (
      <div style={{ width: 300, textAlign: 'center', margin: 'auto', marginTop: 40 }}><i className='fa fa-circle small' style={{ color: '#EB5757', verticalAlign: 'middle', marginRight: 6, paddingBottom: 5 }} /><span style={{ fontFamily: 'Inter UI Medium', fontSize: 18 }}>Get <span style={{ fontFamily: 'Inter UI Black' }}>{transfer.referralAmount} {transfer.tokenSymbol}</span> for every friend you invite to FakeDoge</span></div>
    )
  }
