    ...
    <div>
      <Row style={{ marginBottom: 15 }}>
        <Col style={styles.colVertAlign} xs={3}>
          <div style={styles.amount}><img src={address === transfer.senderAddress ? arrowUp : arrowDown} style={{ display: 'inline', width: 'unset', marginLeft: 12, marginRight: 4, paddingBottom: 3 }} />{transfer.amount}&nbsp;<div style={{ color: '#999999', display: 'inline' }}>{transfer.tokenSymbol}</div></div>
        </Col>
